...
import { DownloadIcon, UploadIcon } from "../../../icons/jsx/upload";
...
import { downloadTaskDataset } from "../../../api/tasks";
...
export const BigMyTask = chakra(
  ({ task, className }: { task: Task; className?: any }) => {
    const [isLoading,setIsLoading] = useState(false)
    const downloadHandler = ()=>{
      setIsLoading(true)
      downloadTaskDataset(task._id.$oid).then(e=>{
